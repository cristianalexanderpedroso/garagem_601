/*
  # Schema completo do sistema Garagem 601
  ...
  2. Segurança
    ...
    - Políticas especiais para consulta pública
...
BEGIN
  ...
  DROP POLICY IF EXISTS "Usuários autenticados podem gerenciar clientes" ON clientes;
  DROP POLICY IF EXISTS "Usuários autenticados podem gerenciar veículos" ON veiculos;
  DROP POLICY IF EXISTS "Usuários autenticados podem gerenciar estoque" ON estoque;
  DROP POLICY IF EXISTS "Usuários autenticados podem gerenciar orçamentos" ON orcamentos;
  DROP POLICY IF EXISTS "Usuários autenticados podem gerenciar itens de orçamento" ON itens_orcamento;
  DROP POLICY IF EXISTS "Usuários autenticados podem gerenciar laudos" ON laudos;
  DROP POLICY IF EXISTS "Usuários autenticados podem gerenciar histórico" ON historico_manutencao;
  DROP POLICY IF EXISTS "Usuários autenticados podem gerenciar agendamentos" ON agendamentos;
  DROP POLICY IF EXISTS "Usuários autenticados podem gerenciar configurações" ON configuracoes;
  DROP POLICY IF EXISTS "Consulta pública pode ver orçamentos" ON orcamentos;
  DROP POLICY IF EXISTS "Consulta pública pode ver veículos" ON veiculos;
  DROP POLICY IF EXISTS "Consulta pública pode ver clientes" ON clientes;
EXCEPTION
...
DROP TRIGGER IF EXISTS update_laudos_updated_at ON laudos;
